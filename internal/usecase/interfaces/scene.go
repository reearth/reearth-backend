...
type Scene interface {
	...
	AddCluster(context.Context, id.SceneID, *string, id.PropertyID, *usecase.Operator) (*scene.Scene, error)
	UpdateCluster(context.Context, UpdateClusterParam, *usecase.Operator) (*scene.Scene, error)
