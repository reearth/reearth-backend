...
func (c *ClientCollection) Paginate(ctx context.Context, filter interface{}, sortFilter *interfaces.AssetFilterType, p *usecase.Pagination, consumer Consumer) (*usecase.PageInfo, error) {
