...
func newDatasetSchema(ctx context.Context, c *DatasetController, o *usecase.Operator) *DatasetSchemaLoader {
...
func newOrdinaryDatasetSchema(ctx context.Context, c *DatasetController, o *usecase.Operator) DatasetSchemaDataLoader {
