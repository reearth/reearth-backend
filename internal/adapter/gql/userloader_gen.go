...
func (l *UserLoader) Load(key id.UserID) (*User, error) {
...
func (l *UserLoader) LoadThunk(key id.UserID) func() (*User, error) {
	l.mu.Lock()
...
func (l *UserLoader) LoadAll(keys []id.UserID) ([]*User, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *UserLoader) LoadAllThunk(keys []id.UserID) func() ([]*User, []error) {
	results := make([]func() (*User, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *UserLoader) Prime(key id.UserID, value *User) bool {
	l.mu.Lock()
	var found bool
...
func (l *UserLoader) unsafeSet(key id.UserID, value *User) {
	if l.cache == nil {
		l.cache = map[id.UserID]*User{}
	}
	l.cache[key] = value
}
...
func (b *userLoaderBatch) keyIndex(l *UserLoader, key id.UserID) int {
