...
func TestBuilder_WidgetSystem(t *testing.T) {
	...
	ws := NewWidgetSystem([]*Widget{
		MustNewWidget(id.WidgetIDFromRefID(&nid), id.OfficialPluginID, "xxx", id.NewPropertyID(), true, WidgetLayout{}),
	})
...
func TestBuilder_Build(t *testing.T) {
	...
	nid := id.New()
	ws := NewWidgetSystem([]*Widget{
		MustNewWidget(id.WidgetIDFromRefID(&nid), id.OfficialPluginID, "xxx", ppid, true, WidgetLayout{}),
	})
	ps := NewPluginSystem([]*Plugin{
