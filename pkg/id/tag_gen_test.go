...
func TestTagIDSet_Add(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expected: &TagIDSet{
				m: map[TagID]struct{}{MustTagID("01f3zhcaq35403zdjnd6dcm0t1"): struct{}{}},
		...
		},
		{
			...
			expected: &TagIDSet{
				m: map[TagID]struct{}{
					MustTagID("01f3zhcaq35403zdjnd6dcm0t1"): struct{}{},
					MustTagID("01f3zhcaq35403zdjnd6dcm0t2"): struct{}{},
					MustTagID("01f3zhcaq35403zdjnd6dcm0t3"): struct{}{},
				},
				s: []TagID{
					MustTagID("01f3zhcaq35403zdjnd6dcm0t1"),
					MustTagID("01f3zhcaq35403zdjnd6dcm0t2"),
	...
	testCases := []struct {
		...
		},
		{
			...
			input: struct {
				...
				b: &TagIDSet{
					m: map[TagID]struct{}{MustTagID("01f3zhcaq35403zdjnd6dcm0t2"): struct{}{}},
