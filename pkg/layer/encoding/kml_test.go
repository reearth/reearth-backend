						...
						Items: []*property.SealedItem{
							{
								...
								Fields: []*property.SealedField{
									...
									},
									{
										...
										PropertyValue: property.ValueTypeNumber.ValueFrom(100),
									},
									{
										ID:            id.PropertySchemaFieldID("imageSize"),
										Type:          property.ValueTypeNumber,
										PropertyValue: property.ValueTypeNumber.ValueFrom(4),
									},
									{
										ID:            id.PropertySchemaFieldID("image"),
										Type:          property.ValueTypeURL,
										PropertyValue: property.ValueTypeURL.ValueFrom("http://maps.google.com/mapfiles/kml/pal4/icon28.png"),
									},
									{
						...
						Items: []*property.SealedItem{
							{
								...
								Fields: []*property.SealedField{
									...
									},
									{
										...
										Type:          property.ValueTypeString,
										PropertyValue: property.ValueTypeString.ValueFrom("#ff334353"),
									},
									{
