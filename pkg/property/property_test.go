...
func TestPropertyMigrateSchema(t *testing.T) {
	...
	fields := []*Field{
		...
		NewFieldUnsafe().FieldUnsafe(schemaField7ID).
			ValueUnsafe(ValueTypeString.ValueFrom("hogehoge")).
			Build(),
